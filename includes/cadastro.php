...
?>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip01" name = "nome" placeholder="Nome" required>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip02" name = "sobrenome" placeholder="Sobrenome"  required>
      <div class="valid-tooltip">
        Tudo certo!
      </div>
    </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip02" name = "senha" placeholder="Senha"  required>
      <div class="valid-tooltip">
        Tudo certo!
      </div>
    </div>
